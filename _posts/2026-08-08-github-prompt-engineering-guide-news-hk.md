...
![Prompt Engineering Guide README 開頭（項目 H1 大字 + 定位描述）]({{ '/assets/images/posts/github-prompt-engineering-guide-news-hk-shot1.png' | relative_url }})
...
![Prompt Engineering Guide GitHub 主頁（repo 名 + 77k stars + 項目描述）]({{ '/assets/images/posts/github-prompt-engineering-guide-news-hk-shot2.png' | relative_url }})
...
<div class="ui-stat-grid">
  <div class="stat-item"><div class="stat-value">77.3k</div><div class="stat-label">Star</div></div>
  <div class="stat-item"><div class="stat-value">8.5k</div><div class="stat-label">Fork</div></div>
...
- DAIR.AI Academy：[線上課程平台](https://academy.dair.ai/)
...
**Q2：指南內容是否免費？**  
GitHub 儲存庫與官方網站內容全部免費開放，採用 MIT 許可證；DAIR.AI Academy 的系統課程則為付費資源。

**Q3：指南支援哪些語言？**  
目前支援 13 種語言，包括英文、中文、日文、法文、西班牙文等，並持續歡迎社群貢獻翻譯。

**Q4：內容會持續更新嗎？**  
會。項目持續追蹤提示工程領域的最新論文與技術，最近更新至 2026 年 8 月，並擴展至上下文工程與 AI Agent 等新主題。
</div>
