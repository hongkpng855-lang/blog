...
Astra 是 OpenAI 首個歸類為 Critical 網絡安全能力的模型，ExploitBench 取得 100% 滿分，能建立瀏覽器逃逸鏈與本機權限提升鏈，並發現兩個零日漏洞。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 85 字 -->
OpenAI 為 Astra 設三層防護：訓練拒絕惡意請求、增加系統級分類器、部署監控偵測未授權行為。越獄評估中它拒絕 91.5% 惡意請求，遠高於 GPT-5.6 Sol 的 59%。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 85 字 -->
Astra 高階網絡安全功能初期僅開放給一小批 alpha 測試者，之後經 Daybreak Blue 計畫擴展防禦用途。一般用戶可能遇到任務被監控暫停並要求確認，屬正常防護運作。
<!-- End AEO Capsule -->
