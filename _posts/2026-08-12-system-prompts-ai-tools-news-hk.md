...
description: "system-prompts-and-models-of-ai-tools 是 GitHub 星標逾 14.2 萬的開源項目，收錄 Claude Code、Cursor、Windsurf、Devin、v0 等主流 AI 工具的系統提示詞與模型設定，採用 GPL-3.0 許可證，揭示提示詞注入與提取風險，是研究 AI 工具架構與提示詞工程的重要公開資料庫。"
author: AnIskill 編輯部
