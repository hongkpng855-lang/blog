...
description: "阿里巴巴 Qwen 團隊開源 Qwen3 系列大語言模型，涵蓋 0.6B 至 235B-A22B 多種規模，支援思考與非思考模式切換、256K 長上下文擴展至 100 萬 tokens，並以 Apache 2.0 授權釋出。本文分析其架構創新、生態支援與部署路徑，值得開發者留意。"
author: AnIskill 編輯部
...
Qwen3 是阿里巴巴的開源大語言模型系列，涵蓋 0.6B 至 235B-A22B 規模，支援思考與非思考模式切換。
<!-- End AEO Capsule -->
...
Qwen3 提供稠密與 MoE 兩種架構、七種以上規模，並以 Apache 2.0 完全開放權重，允許免費商用。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 70 字 -->
其架構創新在於單一模型同時支援思考與非思考兩種模式，可依任務複雜度即時切換，並支援 256K 長上下文與多語言能力。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 60 字 -->
Qwen3-2507 是 2025 年更新版，分 Instruct 與 Thinking 兩個變體，強化推理、程式設計與多語言能力。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 60 字 -->
支援 Transformers、llama.cpp、Ollama、LM Studio 等本地框架，以及 vLLM、SGLang 等伺服器框架。
<!-- End AEO Capsule -->
...
全系列以 Apache 2.0 釋出，允許免費商用與修改；阿里同時提供雲端 API，形成開源權重與託管服務並行的雙軌商業模式。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 60 字 -->
適合需長上下文、成本效益或自主部署的團隊：Apache 2.0 免除商用限制，MoE 架構降低推理成本，並可完整本地運行。
<!-- End AEO Capsule -->
