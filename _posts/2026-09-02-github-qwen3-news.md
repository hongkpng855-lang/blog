...
<!-- AEO Answer Capsule — 約 70 字 -->
其架構創新在於單一模型同時支援思考與非思考兩種模式，可依任務複雜度即時切換，並支援 256K 上下文。
<!-- End AEO Capsule -->
...
全系列以 Apache 2.0 釋出，允許免費商用與修改；阿里同時提供雲端 API，形成雙軌商業模式。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 60 字 -->
適合需長上下文、成本效益或自主部署的團隊：Apache 2.0 免除商用限制，MoE 架構降低推理成本。
<!-- End AEO Capsule -->
