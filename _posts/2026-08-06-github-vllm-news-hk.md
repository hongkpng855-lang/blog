...
description: "vLLM 是 GitHub 星標逾 8.8 萬的開源 LLM 推理與服務引擎，源自柏克萊 Sky Computing Lab，以 PagedAttention 與連續批處理技術實現高吞吐、低成本的模型部署，支援逾 200 種模型架構與多類硬件平台，採用 Apache 2.0 授權，累積逾 3,000 名貢獻者，是企業 AI 推理基礎設施的核心開源項目。"
