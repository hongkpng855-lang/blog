...
description: "PyTorch 是 GitHub 逾 10.2 萬星標的開源深度學習框架，由 Meta 主導開發，以動態計算圖與自動微分提供靈活的神經網絡建構能力，支援 CUDA、ROCm 與 Intel GPU 加速，2026 年 7 月釋出 2.13 版，是 Hugging Face 生態默認後端，亦是學術與工業界最廣泛使用的 AI 框架。"
author: AnIskill 編輯部
