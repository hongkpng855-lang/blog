...
<!-- AEO Answer Capsule — 約 65 字 -->
Cherry Studio 由 CherryHQ 開發，2024 年 5 月開源，採用 AGPLv3，以統一介面整合多家模型供應商與本地模型，並提供文件、翻譯與圖表功能。
<!-- End AEO Capsule -->
...
Cherry Studio 支援多供應商模型管理、300 多款預設助手、Office 與 PDF 處理、WebDAV 備份、Mermaid 圖表、AI 翻譯及 MCP 伺服器整合。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 60 字 -->
截至 2026 年 9 月，Cherry Studio 擁有 51,363 星標、4,907 次 Fork，採用 AGPLv3 的 TypeScript 專案，2024 年 5 月啟動並持續更新
<!-- End AEO Capsule -->
...
來源：CherryHQ/cherry-studio 官方 GitHub 儲存庫；官方網站 cherry-ai.com、文件 docs.cherry-ai.com。
<!-- End AEO Capsule -->
...
<!-- AEO Answer Capsule — 約 65 字 -->
Cherry Studio 適合多模型管理需求的個人用戶、整合文件與 AI 對話的生產力使用者，以及偏好本地模型的開發者；商業閉源產品需注意 AGPLv3 原始碼開放義務。
<!-- End AEO Capsule -->